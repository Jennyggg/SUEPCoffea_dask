...
def makeParser(parser=None):
    ...
    parser.add_argument(
        "--dataDirLocal",
        type=str,
        default="/data/submit/" + getpass.getuser() + "/SUEP/{}/{}/",
        help="Local data directory",
    )
    parser.add_argument(
        "--dataDirXRootD",
        type=str,
        default=f"/" + getpass.getuser() + "/SUEP/{}/{}/",
    ...
    parser.add_argument(
        "--saveDir",
        type=str,
        default=f"/ceph/submit/data/user/{getpass.getuser()[0]}/{getpass.getuser()}/SUEP/outputs/",
...
def plot_systematic(df, metadata, config, syst, options, output, cutflow={}):
    ...
    if options.isMC:
        ...
        # 3) prefire weights
        if options.era == "2016" or options.era == "2017" or options.era == "2016apv":
        ...
        if options.scouting:
            config = {
                "Cluster": {
                    ...
                    "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 60]],
                ...
                "Cluster_ht580": {
                    ...
                    "yvar_regions": [0, 18, 50, 1000],
                    "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 60]],
                    "selections": [["ht", ">", 580], ["ntracks", ">", 0]],
                },
                "Cluster_InvertOffline": {
                    "input_method": "CL",
                    "method_var": "SUEP_S1_CL",
                    "xvar": "SUEP_S1_CL",
                    "xvar_regions": [0.3, 0.34, 0.5, 2.0],
                    ...
                    "yvar_regions": [0, 18, 50, 1000],
                    "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 60]],
                    "selections": [["ht", ">", 560],["ht", "<", 1100], ["ntracks", ">", 0]],
                },
                "Cluster_ht540_InvertOffline": {
                    "input_method": "CL",
                    "method_var": "SUEP_S1_CL",
                    "xvar": "SUEP_S1_CL",
                    "xvar_regions": [0.3, 0.34, 0.5, 2.0],
                    ...
                    "yvar_regions": [0, 18, 50, 1000],
                    "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 60]],
                    "selections": [["ht", ">", 540],["ht", "<", 1100], ["ntracks", ">", 0]],
                },
                "Cluster_ht580_InvertOffline": {
                    "input_method": "CL",
                    "method_var": "SUEP_S1_CL",
                    "xvar": "SUEP_S1_CL",
                    "xvar_regions": [0.3, 0.34, 0.5, 2.0],
                    ...
                    "yvar_regions": [0, 18, 50, 1000],
                    "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 60]],
                    "selections": [["ht", ">", 580],["ht", "<", 1100], ["ntracks", ">", 0]],
                },
                #"Cluster_ht600": {
                #    "input_method": "CL",
                #    "method_var": "SUEP_S1_CL",
                ...
                #    "yvar_regions": [0, 18, 50, 1000],
                #    "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 70]],
                #    "selections": [["ht", ">", 560], ["ntracks", ">", 0],["L1scout",">",0]],
                #},
                "ClusterInverted": {
                    "input_method": "CL",
                ...
                "ClusterInverted_ht540_InvertOffline": {
                    "input_method": "CL",
                    "method_var": "ISR_S1_CL",
                    "xvar": "ISR_S1_CL",
                    "xvar_regions": [0.3, 0.34, 0.5, 2.0],
                ...
                "ClusterInverted_ht580_InvertOffline": {
                    "input_method": "CL",
                    "method_var": "ISR_S1_CL",
                    "xvar": "ISR_S1_CL",
                    "xvar_regions": [0.3, 0.34, 0.5, 2.0],
