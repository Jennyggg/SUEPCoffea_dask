...
class SUEP_cluster(processor.ProcessorABC):
    ...
    def analysis(self, events, do_syst=False, col_label=""):
        ...
        print("Select at least 2 cluster")
        print(tracks) 
        print(indices)
        ...
        SUEP_utils.ClusterMethod(self, indices, tracks, 
                           ...
                           do_inverted=True,
                           out_label=col_label)
        for iselect in range(len(SUEP_cluster_tracks)):
          print("Event ",iselect)
          print("#tracks in SUEP,",len(SUEP_cluster_tracks[iselect]))
          print("#tracks in ISR,",len(ISR_cluster_tracks[iselect]))
        if self.do_inf:
